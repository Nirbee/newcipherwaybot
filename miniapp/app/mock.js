...
window.__MOCK__ = {
  me: {
    ...
    app: { template: "a", title: "VPN", greeting: null, accent_color: null, bot_username: "bot_vpn4_bot", sales_mode: "plans", payment_order: ["balance"], balance_enabled: true },
  },
  ...
  plans: {
    ...
    items: [
      ...
      {
        id: 2,
        public_code: "vpn-router",
        name: "VPN для роутера",
        description: "Один тариф на всю домашнюю сеть",
        traffic_limit_bytes: 0,
        device_limit: 1,
        category: "router",
        is_current: false,
        durations: [
          { days: 30, months: 1, price_minor: 29900, price_stars: 224 },
          { days: 365, months: 12, price_minor: 249000, price_stars: 1820 },
        ],
      },
    ],
  },
